...
class Pattern:
    ...
    def __repr__(self) -> Any: ...
        # return str%(self.find_s,self.repl_s)
    ...
    def match(self, s: str) -> Any: ...
        # return (bool,s)
        # return (bool,self.replace(s))
        # reduced...
        # return (bool,self.replace(str))
        # return (bool,str)
...
class StandAloneMakeStubFile:
    ...
    def create_keys_d(self) -> Any: ...
        # return {}
    def scan_pattern_lists(self, section_name) -> Any: ...
        # return {}
    def scan_patterns(self, section_name) -> Sequence: ...
class StubFormatter(AstFormatter):
    def __init__(self, keys_d, patterns_d) -> None: ...
    def match(self, patterns: Sequence, s: str) -> str: ...
    def visit(self, node: Node) -> str: ...
    def do_BoolOp(self, node: Node) -> str: ...
    def do_Bytes(self, node: Node) -> str: ...
    def do_Name(self, node: Node) -> str: ...
...
class StubTraverser(ast.NodeVisitor):
    ...
    def indent(self, s: str) -> Any: ...
        # return str%(str*number*self.level,s)
        # reduced...
        # return str%(str*number*self.level,str)
    ...
    def munge_arg(self, s: str) -> Any: ...
        # return str%(s,pattern.repl_s)
        # return s
        # return str%(s,default_pattern.repl_s)
        # reduced...
        # return str
        # return str%(str,default_pattern.repl_s)
        # return str%(str,pattern.repl_s)
    def format_returns(self, node: Node) -> str: ...
    def format_return_expressions(self, aList1, aList: Sequence, kind) -> Any: ...
        # return s+str
        # reduced...
        # return str+comments
        # return str+str
    def is_known_type(self, s: str) -> Any: ...
        ...
        # reduced...
        # return all(self.is_known_type(z) for z in str.split(str))
        # return bool
        # return self.is_known_type(str[number:number])
    def get_def_name(self, node: Node) -> Any: ...
        # return name
...
class TestClass:
    ...
    def parse_group(group: str) -> Any: ...
        # return (ndots,os.sep.join(group[::number]))
        # reduced...
        # return (int,str)
def main() -> None: ...
def pdb() -> None: ...
