...
class StubTraverser(ast.NodeVisitor):
    ...
    def match_args(self, name: str, s: str) -> str: ...
    def match_balanced_patterns(self, name: str, s: str) -> str: ...
    def match_return_patterns(self, name: str, s: str, i: int) -> str: ...
    def match_return_pattern(self, pattern: str, s: str, i: int) -> str: ...
    def match_balanced(self, delim: str, s: str, i: int) -> str: ...
