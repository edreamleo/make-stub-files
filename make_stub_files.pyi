# make_stub_files: Thu 17 Mar 2016 at 19:40:51
...
def reduce_types(aList: List[Any], name: str=None, trace: bool=bool) -> Any: ...
...
class LeoGlobals:
    class NullObject:
        ...
        def __setattr__(self, attr: Any, val: Any) -> Any: ...
            #   0: return self
            # ? 0: return self
    def _callerName(self, n: int=1, files: Any=bool) -> str: ...
    def callers(self, n: int=4, count: Any=0, excludeCaller: Any=bool, files: Any=bool) -> str: ...
    def cls(self) -> None: ...
    def pdb(self) -> None: ...
...
class Pattern(object):
    ...
    def match(self, s: str, trace: bool=bool) -> Tuple[bool, str]: ...
...
class ReduceTypes:
    def __init__(self, aList: List[Any]=None, name: str=None, trace: bool=bool) -> None: ...
    def is_known_type(self, s: str) -> Union[Union[Any, bool], bool]: ...
    def reduce_collection(self, aList: List[Any], kind: Any) -> Any: ...
        #   0: return result
        # ? 0: return result
    ...
    def show(self, s: str, known: Any=bool) -> str: ...
...
class StubFormatter(AstFormatter):
    seen_names = Any # Added...
    def __init__(self, controller: StandAloneMakeStubFile, traverser: Any) -> None: ...
    def match_all(self, node: Node, s: str, trace: bool=bool) -> str: ...
    # def visit(self, node: Node) -> str: ...
...
class StubTraverser(ast.NodeVisitor):
    ...
    def merge_stubs(self, new_stubs: Any, old_root: Any, new_root: Any, trace: bool=bool) -> None: ...
