...
def merge_types(a1: Any, a2: Any) -> Any: ...
    ...
    # ? 0: return sorted(Set[r1+r2])
def pdb(self) -> None: ...
def reduce_numbers(aList: List) -> Any: ...
    #   0: return aList
    # ? 0: return aList
def reduce_types(aList: List, newlines: Any=False) -> str: ...
    #   0: return 'None'
    #   0: return str
    #   1: return 'Any'
    #   1: return str
    #   2: return r[0]
    #   2: return str
    #   3: return 'Optional[%s]'%r[0]
    #   3: return str
    #   4: return r[0]
    #   4: return str
    #   5: return 'Union[\n    %s,\n]'%',\n    '.join(sorted(r))
    #   5: return str
    #   6: return 'Union[%s]'%', '.join(sorted(r))
    #   6: return str
def split_types(s: str) -> Any: ...
    #   0: return aList
    # ? 0: return aList
