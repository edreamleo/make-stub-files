...
class Pattern(object):
    ...
    def full_balanced_match(self, s: str, i: int) -> Any: ...
        ...
        # ? 0: return Union[O, [, ], a, i, i, l, n, n, o, p, t, t]
...
class ReduceTypes:
    ...
    def is_known_type(self, s: str) -> Union[Any, bool]: ...
    ...
    def merge_lists(self, aList: List[Any]) -> Any: ...
        #   0: return self.merge_collection(aList,'List')
        # ? 0: return self.merge_collection(List[Any], str)
    def merge_unions(self, aList: List[Any]) -> Any: ...
        #   0: return self.merge_collection(aList,'Union')
        # ? 0: return self.merge_collection(List[Any], str)
...
class StubTraverser(ast.NodeVisitor):
    ...
    def update(self, fn: str, new_root: Any) -> Any: ...
        ...
        #   3: return new_root
        # ? 3: return new_root
    def get_stub_file(self, fn: str) -> Union[O, [, ], a, i, l, n, o, p, r, s, t, t]: ...
