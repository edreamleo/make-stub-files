# make_stub_files: Wed 10 Feb 2016 at 05:47:58
...
class StubTraverser(ast.NodeVisitor):
    ...
    def update(self, fn: str, new_stubs: Any) -> Any: ...
        #   0: return new_stubs
        # ? 0: return new_stubs
        #   1: return new_stubs
        # ? 1: return new_stubs
    ...
    def find_parent_stub(self, stub: Any, stubs: Any) -> None: ...
    def find_stub(self, stub: Any, stubs: Any) -> bool: ...
    def sort_stubs_by_hierarchy(self, stubs1: Any) -> Any: ...
        #   0: return len(parents)-1
        #   0: return number
        #   1: return result
        # ? 1: return result
        #   2: return []
        #   2: return List[]
        def level(stub: Any) -> number: ...
    def trace_stubs(self, stub: Any, header: Any=None, level: Any=-1) -> None: ...
