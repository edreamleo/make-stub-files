...
class StandAloneMakeStubFile:
    ...
    def scan_patterns(self, section_name: str) -> Sequence: ...
...
class StubTraverser(ast.NodeVisitor):
    ...
    def format_return_expressions(self, aList: Sequence, kind: str) -> Any: ...
        # str+comments
        # str+str
    def is_known_type(self, s: str) -> bool: ...
    def get_def_name(self, node: Node) -> str: ...
    def munge_ret(self, name: str, s: str) -> str: ...
    def match_return_patterns(self, name: str, patterns: Sequence, s: str) -> Tuple[bool,str]: ...
