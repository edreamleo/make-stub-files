# make_stub_files: Wed 10 Feb 2016 at 14:30:58
...
def dump_dict(d: Any, tag: Any) -> None: ...
def dump_list(aList: List[Any], tag: Any) -> None: ...
...
class StubTraverser(ast.NodeVisitor):
    ...
    def find_parent_stub(self, stub: Any, stubs: Any) -> Any: ...
        #   0: return self.find_stub(stub.parent,stubs)
        # ? 0: return self.find_stub(stub.parent, stubs)
        #   1: return stubs.children[stubs.children.index(stub)]
        # ? 1: return stubs.children[stubs.children.index(stub)]
        #   2: return None
        #   2: return None
    def find_stub(self, stub: Any, stubs: Any) -> Any: ...
        #   0: return stubs
        # ? 0: return stubs
        #   1: return stub2
        # ? 1: return stub2
