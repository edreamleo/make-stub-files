...
class AstFormatter:
    ...
    def format(self, node: Node) -> Union[Any, number, str]: ...
...
class Pattern(object):
    ...
    def match_entire_string(self, s: str) -> Union[Any, bool, number]: ...
...
def main() -> None: ...
def pdb() -> None: ...
def reduce_numbers(aList: List) -> List: ...
def reduce_types(aList: List) -> str: ...
