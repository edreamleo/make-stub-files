...
class Pattern:
    ...
    def all_matches(self, str, trace: bool=False) -> Sequence: ...
    def full_balanced_match(self, str, i: int, trace: bool=False) -> Optional[int]: ...
    def match_balanced(self, delim, str, i: int, trace: bool=False) -> int: ...
    def match(self, str, trace: bool=False) -> Tuple[bool,str]: ...
    def match_entire_string(self, str, trace: bool=False) -> bool: ...
    def replace(self, m, str, trace: bool=False) -> str: ...
...
class StubFormatter(AstFormatter):
    ...
    def match(self, patterns: Sequence, str) -> str: ...
    def visit(self, node: Node) -> str: ...
    def do_BoolOp(self, node: Node) -> str: ...
    def do_Bytes(self, node: Node) -> str: ...
    def do_Name(self, node: Node) -> str: ...
