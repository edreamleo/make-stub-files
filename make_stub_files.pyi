...
def all_matches(self, s: str) -> 
    Sequence, 
    tuple(m.start(),m.end()) for m in self.regex.finditer(str): ...
def full_balanced_match(self, pattern: str, s: str, i: int) -> j if found else None: ...
def match_balanced(self, delim: str, s: str, i: int) -> int, len(str)+number: ...
